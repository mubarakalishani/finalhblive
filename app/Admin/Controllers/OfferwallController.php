...
class OfferwallController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('starter_cp', __('Starter cp'));
        $grid->column('advance_cp', __('Advance cp'));
        $grid->column('expert_cp', __('Expert cp'));
        $grid->column('ref_commission', __('Ref commission'));
        $grid->column('tier1_hold_amount', __('Tier1 hold amount'));
        $grid->column('tier1_hold_time', __('Tier1 hold time'));
        $grid->column('tier2_hold_amount', __('Tier2 hold amount'));
        $grid->column('tier2_hold_time', __('Tier2 hold time'));
        $grid->column('tier3_hold_amount', __('Tier3 hold amount'));
        $grid->column('tier3_hold_time', __('Tier3 hold time'));
