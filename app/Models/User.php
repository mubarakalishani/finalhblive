...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'balance', 'deposit_balance', 'bonus_balance', 'diamond_level_balance', 'instant_withdrawable_balance', 'total_earned','total_withdrawn', 'total_deposited', 'earned_from_referrals',
